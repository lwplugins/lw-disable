...
final class NoticeManager {
	...
	public static function init(): void {
		...
		add_action( 'admin_head', array( self::class, 'inject_styles' ) );
		add_action( 'admin_notices', array( self::class, 'open_wrap' ), -9999 );
		add_action( 'admin_notices', array( self::class, 'close_wrap' ), PHP_INT_MAX );
